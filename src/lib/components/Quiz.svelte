...
<button
	class={`flex h-3/5 w-2/7 flex-col rounded-2xl shadow ring ring-soft-linen-200 dark:ring-dusk-blue-800 object-cover transition-all overflow-hidden gap-2 items-center  ${selected === idx ? 'ring-2 ring-dusk-blue-500' : ''}`}
